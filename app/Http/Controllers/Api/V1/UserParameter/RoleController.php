...
class RoleController extends Controller
{
    ...
    public function list(Request $request, $id = null){
        try{
            if($id){
                ...
                $role = Role::where('status', static::$DATA_STATUS_ACTIVE)->get();
            }

            $this->handleSuccessResponse($request, true, 'List Role',['data' => $role]);
        }
        catch(Exception $e){
    ...
    public function insert(Request $request){
        ...
        try{
            ...
            $data = Role::create($formData);

            DB::commit();

            $this->handleSuccessResponse($request, true, 'Insert New Role',['data' => $data]);
        }
    ...
    public function update(Request $request, $id){
        ...
        try{
            ...
            $this->handleSuccessResponse($request, true, 'Update Role',['data' => $role]);
        }
        catch(ValidationException $e){
            $this->handleException($request, $e->errors(), 422);
        }
    ...
    public function delete(Request $request, $id){
        ...
        try{
            ...
            DB::commit();
            $this->handleSuccessResponse($request, true, 'Delete Role',['data' => $role]);
        }
        catch(ValidationException $e){
            $this->handleException($request, $e->errors(), 422);
        }
